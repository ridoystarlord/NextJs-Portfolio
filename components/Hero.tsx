...
const Hero = () => {
  return (
    <section className="bg-[url('/bg-1.jpg')] bg-cover bg-center bg-no-repeat py-5 md:h-[88.6vh] md:py-0">
      <div className="container flex h-full flex-col items-center justify-center px-5 text-white md:flex-row md:space-x-10 md:px-0">
        <div className="space-y-8 text-center md:w-1/2 md:text-left">
          <h1 className="mb-4 flex flex-col gap-2">
            <span className="text-xl text-orange-500">Hello, I’m</span>
            <span className="text-3xl font-bold text-white md:text-5xl">
              Mehedi Hasan Ridoy
            </span>
          </h1>
          <h2 className="mb-2 text-lg font-medium md:text-2xl">
            A <span className="text-green-400">Javascript Developer</span> From{' '}
            <span className="text-purple-400">Bangladesh</span>
          </h2>
          <button className="rounded-full bg-orange-600 px-10 py-3 font-bold text-white hover:bg-orange-500">
            About Me
          </button>
        ...
        <div className="relative mt-10 flex justify-center md:mt-0 md:w-1/2 md:justify-center">
          <div className="relative">
            ...
            <div className="absolute left-0 top-0">
              <div className="animate-bounceSlow rounded-full">
                <svg
