...
const Banner = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-gray-800 via-gray-900 to-black">
      <div className="container grid grid-cols-1 gap-6 px-5 py-5 md:grid-cols-3 md:px-0 md:py-20">
        {features.map((feature: any, i: number) => (
          <div className="flex flex-col items-center gap-4" key={i}>
            <div className="relative rounded-full p-4">
              <img src={feature.backgroundIcon} alt={`Background Icon`} />
              <div className="absolute left-1/2 top-1/2 h-10 w-10 -translate-x-1/2 -translate-y-1/2 transform">
                {feature.ForegroundIcon}
              </div>
            </div>
